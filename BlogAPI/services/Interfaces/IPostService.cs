...
public interface IPostService
{
    ...
    Task<IActionResult> CreateUserPost(CreatePostDto createPostDto);
    Task<PostFullDto> GetPostById(Guid postId);
    Task<IActionResult> LikePost(Guid postId);
    Task<IActionResult> UnlikePost(Guid postId);
    Task<IActionResult> CreateCommunityPost(Guid communityId, string? communityName, CreatePostDto createPostDto);
